...
export const list = query({
  args: {
    ...
    includePublicOnly: v.optional(v.boolean()), // Only show public carts if true
  },
  handler: async (ctx, { genres, search, sort, limit, includePublicOnly }) => {
    let query = ctx.db.query('carts')
