      ...
      .then((data) => {
        ...
        const processed = JSON.parse(
          JSON.stringify(data)
            ...
            .replace(/{APP_EMAIL_LEGAL}/g, "nlaakstudios@pm.me")
            .replace(/{APP_EMAIL_DMCA}/g, "nlaakstudios@pm.me")
        );
        setTerms(processed);
      })
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-gray-800 rounded-xl p-6">
          <p className="text-gray-300">Loading terms of service...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto p-6 relative min-h-screen">
      ...
      <div className="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="text-center space-y-2 mb-8 border-b border-gray-700 bg-gray-700/50 px-6 py-8">
          <h1 className="text-3xl font-bold text-retro-400">{terms.title}</h1>
          <p className="text-sm text-gray-400">Last Updated: {terms.lastUpdated}</p>
        </div>
            ...
            <section key={section.id} className="mb-8">
              ...
              {section.content.map((content, contentIdx) => {
                if (typeof content === "string") {
                  ...
                  return (
                    <p key={contentIdx} className="mb-4 text-gray-300">
                      {content}
                    </p>
                  );
        ...
        <div className="flex flex-col space-y-4 text-center border-t border-gray-700 bg-gray-700/50 p-6">
          <p className="text-sm text-gray-300">{terms.footer.text}</p>
